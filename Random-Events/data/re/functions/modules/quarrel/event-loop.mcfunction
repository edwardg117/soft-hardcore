...
execute if entity @a[tag=Quarry_One,nbt={Dimension:"minecraft:the_nether"}] run title @a[tag=Quarry_Two] actionbar ["",{"selector":"@a[tag=Quarry_One]"},{"text":" D: ","bold":true,"color":"yellow"},{"text":"Nether","bold":true,"color":"gold"},{"text":" X: ","bold":true,"color":"yellow"},{"score":{"name":"One_X","objective":"quarrel"},"bold":true,"color":"gold"},{"text":" Y: ","bold":true,"color":"yellow"},{"score":{"name":"One_Y","objective":"quarrel"},"bold":true,"color":"gold"},{"text":" Z: ","bold":true,"color":"yellow"},{"score":{"name":"One_Z","objective":"quarrel"},"bold":true,"color":"gold"}]
#   If Quarry_Two is in Overworld:
execute if entity @a[tag=Quarry_One,nbt={Dimension:"minecraft:overworld"}] run title @a[tag=Quarry_Two] actionbar ["",{"selector":"@a[tag=Quarry_One]"},{"text":" D: ","bold":true,"color":"yellow"},{"text":"Overworld","bold":true,"color":"gold"},{"text":" X: ","bold":true,"color":"yellow"},{"score":{"name":"One_X","objective":"quarrel"},"bold":true,"color":"gold"},{"text":" Y: ","bold":true,"color":"yellow"},{"score":{"name":"One_Y","objective":"quarrel"},"bold":true,"color":"gold"},{"text":" Z: ","bold":true,"color":"yellow"},{"score":{"name":"One_Z","objective":"quarrel"},"bold":true,"color":"gold"}]
#   If Quarry_Two is in End:
execute if entity @a[tag=Quarry_One,nbt={Dimension:"minecraft:the_end"}] run title @a[tag=Quarry_Two] actionbar ["",{"selector":"@a[tag=Quarry_One]"},{"text":" D: ","bold":true,"color":"yellow"},{"text":"The End","bold":true,"color":"gold"},{"text":" X: ","bold":true,"color":"yellow"},{"score":{"name":"One_X","objective":"quarrel"},"bold":true,"color":"gold"},{"text":" Y: ","bold":true,"color":"yellow"},{"score":{"name":"One_Y","objective":"quarrel"},"bold":true,"color":"gold"},{"text":" Z: ","bold":true,"color":"yellow"},{"score":{"name":"One_Z","objective":"quarrel"},"bold":true,"color":"gold"}]
