...
execute unless entity @a[scores={re_kyle_player=1,isDead=0,respawns=1..}] run say lose condition met

execute unless entity @e[tag=Re_Kyle] run say win condition met
