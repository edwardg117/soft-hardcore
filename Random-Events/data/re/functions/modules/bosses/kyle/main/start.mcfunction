...
execute as @e[type=armor_stand,tag=re_kyle_pos,limit=1] at @s run summon vindicator ~ ~ ~ {Glowing:1b,Silent:0b,CustomNameVisible:1b,PortalCooldown:20000000,PersistenceRequired:1b,Health:500f,Tags:["RE_Kyle"],CustomName:'{"text":"Kyle","color":"red","bold":true,"underlined":true}',Attributes:[{Name:generic.max_health,Base:500},{Name:generic.follow_range,Base:60}]}
...
scoreboard players set @a re_kyle_jdie 0
